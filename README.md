...
- 9:159:34 ET: runs a **Morning Study**  pulls market context, economic calendar, gap scan, breadth, trading history, and asks Claude to produce a structured Daily Trading Plan
- 9:3515:44 ET: scans the watchlist, scores every setup with a programmatic signal scorer, enriches survivors with options flow / dark pool / insider data, then sends a curated shortlist to Claude for final buy/sell decisions
...
+-- analysis/
   ...
   +-- signal_scorer.py    # Programmatic setup scoring (010 scale)
